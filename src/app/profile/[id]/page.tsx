...
const USER_DIRECTORY: Record<string, {
  ...
  u1:  { id: "u1",  name: "Kai Nakamura",  email: "kai@example.com",     role: "client",  plan: "pro",   status: "active",   trainer: "Jordan Lee"  },
  u2:  { id: "u2",  name: "Priya Sharma",  email: "priya@example.com",   role: "client",  plan: "elite", status: "active",   trainer: "Jordan Lee"  },
  u3:  { id: "u3",  name: "Marcus Webb",   email: "marcus@example.com",  role: "trainer", plan: "pro",   status: "active"                          },
  u4:  { id: "u4",  name: "Jordan Lee",    email: "jordan@example.com",  role: "trainer", plan: "elite", status: "active"                          },
  ...
  u7:  { id: "u7",  name: "Sofia Reyes",   email: "sofia@example.com",   role: "client",  plan: "elite", status: "active",   trainer: "Jordan Lee"  },
  ...
  u11: { id: "u11", name: "Claire Dubois", email: "claire@example.com",  role: "client",  plan: "pro",   status: "at-risk",  trainer: "Jordan Lee"  },
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <span className={cn("text-xs font-medium capitalize", ROLE_COLOR[target.role])}>
                  {target.role}
                </span>
