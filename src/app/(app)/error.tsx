...
export default function AuthenticatedAppError({
  ...
  useEffect(() => {
    console.error("[authenticated app error boundary]", error);
  }, [error]);
    ...
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center px-5 text-white">
      <div className="max-w-sm w-full text-center space-y-5">
        ...
        <div className="space-y-2">
          <h1 className="text-xl font-semibold tracking-tight">This page could not finish loading.</h1>
          <p className="text-sm text-white/45">
            Your session is still protected. Try again, or return to login.
          </p>
        </div>
